...
namespace SenoraRP_Chatlog_Assistant.Controllers
{
    public static class StartupController
    {
        ...
        private const string ShortcutName = "senorarp-parser.lnk";
        ...
        private static void TryAddingToStartup(bool showError = true)
        {
            ...
            {
                if (showError)
                    MessageBox.Show("An error occured while trying to enable the automatic startup function.", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
        ...
        private static void TryRemovingFromStartup(bool showError = true)
        {
            ...
            {
                if (showError)
                    MessageBox.Show("An error occured while trying to disable the automatic startup function.", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
